...
for i, shift in enumerate(shift_):
    ...
    drawCircularGasket(pltr, mcircles["cA"], n1, depth2, phi1, shift)
    drawCircularGasket(pltr, mcircles["cB"], n2, depth2, phi2, shift)
    drawCircularGasket(pltr, mcircles["cC"], n3, depth2, phi3, shift)
    png = "zpic_Malfatti%03d.png" % i
    pltr.show(screenshot=png)

os.system(
    "magick convert -dispose previous -loop 0 -delay 8 zpic_Malfatti*.png MalfattiGaskets.gif"    
) 